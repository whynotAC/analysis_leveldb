/*
 * C bindings for leveldb. May be useful as stable API that can be
...
LEVELDB_EXPORT void leveldb_iter_seek(leveldb_iterator_t*, const char* k,
                                        size_t klen);
LEVELDB_EXPORT void leveldb_iter_next(leveldb_itertor_t*);
 ...
 * may need to call this routine instread of free(ptr) to dispose of 
